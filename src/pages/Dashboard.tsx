        ...
        <div className="bg-white border-b border-primary-100 p-6">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-3">
              ...
              <select value={selectedTimeRange} onChange={e => setSelectedTimeRange(e.target.value)} className="px-3 py-2 border border-primary-200 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500">
        ...
        <div className="p-6 space-y-8">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {kpiData.map(kpi => <KpiCard key={kpi.title} title={kpi.title} value={kpi.value} description={kpi.description} trend={kpi.trend} sparklineData={kpi.sparklineData} icon={kpi.icon} tooltip={kpi.tooltip} formatValue={kpi.formatValue} onClick={() => handleKpiClick(kpi.title)} />)}
            </div>
          </div>
                  ...
                  <div className="h-80">
                    <ResponsiveContainer width="100%" height="100%">
                      <LineChart data={spendEngagementData} onClick={handleFilterByChart}>
                        ...
                        <Line type="monotone" dataKey="spend" stroke="#0066CC" strokeWidth={3} name="Spend ($)" dot={{
                        fill: '#0066CC',
                        strokeWidth: 2,
                        r: 4
                      }} activeDot={{
                        ...
                        <Line type="monotone" dataKey="engagement" stroke="#1A3E5C" strokeWidth={3} name="Engagement" dot={{
                        fill: '#1A3E5C',
                        strokeWidth: 2,
                        r: 4
                      }} activeDot={{
          ...
          <div className="space-y-6">
            ...
            <Card className="shadow-card hover:shadow-card-hover transition-shadow bg-white border-primary-100">
              ...
              <CardContent>
                <div className="space-y-4">
                  {recentActivities.map((activity, index) => <div key={index} className="flex items-center justify-between py-4 px-4 rounded-lg hover:bg-primary-25 transition-colors border border-transparent hover:border-primary-100 group">
          ...
          <QuickActionsToolbar onLaunchCampaign={() => console.log("Launch new campaign")} onExportReport={() => console.log("Export report")} onAddFunds={() => console.log("Add funds")} />
        </div>
      </div>
    </TooltipProvider>;
};
