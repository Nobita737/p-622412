    ...
    <TableCell>
      <div className="flex space-x-2 opacity-0 group-hover:opacity-100 transition-opacity">
        ...
        {payment.status === "Failed" && (
          <Button variant="outline" size="sm" className="bg-red-50 text-red-700 hover:bg-red-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card className="hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <CardContent>
              ...
              <Badge variant="secondary" className="mt-2 text-xs bg-blue-50 text-blue-700">
                +$50K this quarter
              </Badge>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <CardContent>
              ...
              <Badge variant="secondary" className="mt-2 text-xs bg-teal-50 text-teal-700">
                Available
              </Badge>
            </CardContent>
          </Card>
            ...
            <Card key={payment.id} className="hover:shadow-lg transition-shadow">
              <CardContent className="p-4">
                ...
                <div className="flex space-x-2">
                  {payment.status === "Pending" && (
                    <Button variant="outline" size="sm" className="flex-1 bg-green-50 text-green-700">
                      Process
                    </Button>
                  )}
                  {payment.status === "Failed" && (
                    <Button variant="outline" size="sm" className="flex-1 bg-red-50 text-red-700">
                      Retry
                    </Button>
                  )}
